            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register.step1') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary" id="verify-phone">Verify</button>
                                    @error('phone')
                        ...
                        <div class="row mb-3">
                            <label for="nid" class="col-md-4 col-form-label text-md-end">{{ __('NID Number') }}</label>

                            <div class="col-md-6">
                                <div class="input-group">
                                    <input id="nid" type="text" class="form-control @error('nid') is-invalid @enderror" name="nid" value="{{ old('nid') }}" required autocomplete="nid">
                                    <button type="button" class="btn btn-outline-secondary" id="verify-nid">Verify</button>
                                    @error('nid')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
...
<script>
    ...
    document.getElementById('verify-nid').addEventListener('click', function() {
        // Implement NID verification logic here
        alert('NID verification initiated!');
    });
</script>
@endsection